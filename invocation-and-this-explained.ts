...
*/
function greeting(this:any, person: string){
...
var people = {
    name: "John Smith",
    welcome: function(thing: string) {
      console.log(this.name + " says welcome " + thing);
    }
  }
  
  var linkDyn = function(thing: string) { return people.welcome.call(people, thing); }
  linkDyn("Jimmy");
